...
parser.add_argument("--rclone_folder", help="Rclone远程文件夹", default="onedrive:/qinglong")
...
if __name__ == "__main__":
    ...
    if len(args.rclone_folder) > 0:
        rclone_folder = args.rclone_folder
...
Check out the configuration reference at https://huggingface.co/docs/hub/spaces-config-reference
    ...
    api.create_repo(
        ...
        space_secrets=[
            ...
            {"key": "RCLONE_FOLDER", "value": rclone_folder},
        ],
    )
